...
INPUT_DATABASE_SCHEMA_NAME = os.environ.get("INPUT_DATABASE_SCHEMA_NAME", "public")
TBLS_YML = f"""
...
def filter_table(table):
    ...
    remove_link_name = re.sub(r"\("+INPUT_DATABASE_SCHEMA_NAME+r"\..*\.md\)", " ",remove_right_bracket)
...
def get_table(filename):
    ...
    file_path = PATH_TO_TEMP_FOLDER + f"{INPUT_DATABASE_SCHEMA_NAME}." + filename + FILE_EXTENSION
